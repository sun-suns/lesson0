...
enum CustomBlock {
    ...
    //% blockIdentity="blocks.block" enumval=221 block="橙色の彩釉テラコッタ"
    //% jres alias=ORANGE_GLAZED_TERRACOTTA
    OrangeGlazedTerracotta = 221,
    //% blockIdentity="blocks.block" enumval=222 block="赤紫色の彩釉テラコッタ"
    //% jres alias=MAGENTA_GLAZED_TERRACOTTA
    MagentaGlazedTerracotta = 222,
    //% blockIdentity="blocks.block" enumval=223 block="空色の彩釉テラコッタ"
    //% jres alias=LIGHT_BLUE_GLAZED_TERRACOTTA
    LightBlueGlazedTerracotta = 223,
    //% blockIdentity="blocks.block" enumval=224 block="黄色の彩釉テラコッタ"
    //% jres alias=YELLOW_GLAZED_TERRACOTTA
    YellowGlazedTerracotta = 224,
    //% blockIdentity="blocks.block" enumval=225 block="黄緑色の彩釉テラコッタ"
    //% jres alias=LIME_GLAZED_TERRACOTTA
    LimeGlazedTerracotta = 225,
    //% blockIdentity="blocks.block" enumval=226 block="桃色の彩釉テラコッタ"
    //% jres alias=PINK_GLAZED_TERRACOTTA
    PinkGlazedTerracotta = 226,
    //% blockIdentity="blocks.block" enumval=227 block="灰色の彩釉テラコッタ"
    //% jres alias=GRAY_GLAZED_TERRACOTTA
    GrayGlazedTerracotta = 227,
    //% blockIdentity="blocks.block" enumval=228 block="薄灰色の彩釉テラコッタ"
    //% jres alias=LIGHT_GRAY_GLAZED_TERRACOTTA
    LightGrayGlazedTerracotta = 228,
    //% blockIdentity="blocks.block" enumval=229 block="青緑色の彩釉テラコッタ"
    //% jres alias=CYAN_GLAZED_TERRACOTTA
    CyanGlazedTerracotta = 229,
    //% blockIdentity="blocks.block" enumval=231 block="青色の彩釉テラコッタ"
    //% jres alias=BLUE_GLAZED_TERRACOTTA
    BlueGlazedTerracotta = 231,
    //% blockIdentity="blocks.block" enumval=232 block="茶色の彩釉テラコッタ"
    //% jres alias=BROWN_GLAZED_TERRACOTTA
    BrownGlazedTerracotta = 232,
    //% blockIdentity="blocks.block" enumval=233 block="緑色の彩釉テラコッタ"
    //% jres alias=GREEN_GLAZED_TERRACOTTA
    GreenGlazedTerracotta = 233,
    //% blockIdentity="blocks.block" enumval=234 block="赤色の彩釉テラコッタ"
    //% jres alias=RED_GLAZED_TERRACOTTA
    RedGlazedTerracotta = 234,
    //% blockIdentity="blocks.block" enumval=235 block="黒色の彩釉テラコッタ"
    //% jres alias=BLACK_GLAZED_TERRACOTTA
    BlackGlazedTerracotta = 235,
    //% blockIdentity="blocks.block" enumval=236 block="白色のコンクリート"
    //% jres alias=WHITE_CONCRETE
    WhiteConcrete = 236,
    //% blockIdentity="blocks.block" enumval=65772 block="橙色のコンクリート"
    //% jres alias=ORANGE_CONCRETE
    OrangeConcrete = 65772,
    //% blockIdentity="blocks.block" enumval=131308 block="赤紫色のコンクリート"
    //% jres alias=MAGENTA_CONCRETE
    MagentaConcrete = 131308,
    //% blockIdentity="blocks.block" enumval=196844 block="空色のコンクリート"
    //% jres alias=LIGHT_BLUE_CONCRETE
    LightBlueConcrete = 196844,
    //% blockIdentity="blocks.block" enumval=262380 block="黄色のコンクリート"
    //% jres alias=YELLOW_CONCRETE
    YellowConcrete = 262380,
    //% blockIdentity="blocks.block" enumval=327916 block="黄緑色のコンクリート"
    //% jres alias=LIME_CONCRETE
    LimeConcrete = 327916,
    //% blockIdentity="blocks.block" enumval=393452 block="桃色のコンクリート"
    //% jres alias=PINK_CONCRETE
    PinkConcrete = 393452,
    //% blockIdentity="blocks.block" enumval=458988 block="灰色のコンクリート"
    //% jres alias=GRAY_CONCRETE
    GrayConcrete = 458988,
    //% blockIdentity="blocks.block" enumval=524524 block="薄灰色のコンクリート"
    //% jres alias=LIGHT_GRAY_CONCRETE
    LightGrayConcrete = 524524,
    //% blockIdentity="blocks.block" enumval=590060 block="青緑色のコンクリート"
    //% jres alias=CYAN_CONCRETE
    CyanConcrete = 590060,
    //% blockIdentity="blocks.block" enumval=655596 block="紫色のコンクリート"
    //% jres alias=PURPLE_CONCRETE
    PurpleConcrete = 655596,
    //% blockIdentity="blocks.block" enumval=721132 block="青色のコンクリート"
    //% jres alias=BLUE_CONCRETE
    BlueConcrete = 721132,
    //% blockIdentity="blocks.block" enumval=786668 block="茶色のコンクリート"
    //% jres alias=BROWN_CONCRETE
    BrownConcrete = 786668,
    //% blockIdentity="blocks.block" enumval=852204 block="緑色のコンクリート"
    //% jres alias=GREEN_CONCRETE
    GreenConcrete = 852204,
    //% blockIdentity="blocks.block" enumval=917740 block="赤色のコンクリート"
    ...
    //% blockIdentity="blocks.block" enumval=131313 block="赤紫色の色付きガラス"
    //% jres alias=MAGENTA_STAINED_GLASS
    MagentaStainedGlass = 131313,
    //% blockIdentity="blocks.block" enumval=196849 block="空色の色付きガラス"
    //% jres alias=LIGHT_BLUE_STAINED_GLASS
    LightBlueStainedGlass = 196849,
    //% blockIdentity="blocks.block" enumval=262385 block="黄色の色付きガラス"
    //% jres alias=YELLOW_STAINED_GLASS
    YellowStainedGlass = 262385,
    //% blockIdentity="blocks.block" enumval=327921 block="黄緑色の色付きガラス"
    //% jres alias=LIME_STAINED_GLASS
    LimeStainedGlass = 327921,
    //% blockIdentity="blocks.block" enumval=393457 block="桃色の色付きガラス"
    //% jres alias=PINK_STAINED_GLASS
    PinkStainedGlass = 393457,
    //% blockIdentity="blocks.block" enumval=458993 block="灰色の色付きガラス"
    //% jres alias=GRAY_STAINED_GLASS
    GrayStainedGlass = 458993,
    //% blockIdentity="blocks.block" enumval=524529 block="薄灰色の色付きガラス"
    //% jres alias=LIGHT_GRAY_STAINED_GLASS
    LightGrayStainedGlass = 524529,
    //% blockIdentity="blocks.block" enumval=590065 block="青緑色の色付きガラス"
    //% jres alias=CYAN_STAINED_GLASS
    CyanStainedGlass = 590065,
    //% blockIdentity="blocks.block" enumval=655601 block="紫色の色付きガラス"
    //% jres alias=PURPLE_STAINED_GLASS
    PurpleStainedGlass = 655601,
    //% blockIdentity="blocks.block" enumval=721137 block="青色の色付きガラス"
    //% jres alias=BLUE_STAINED_GLASS
    BlueStainedGlass = 721137,
    //% blockIdentity="blocks.block" enumval=786673 block="茶色の色付きガラス"
    //% jres alias=BROWN_STAINED_GLASS
    BrownStainedGlass = 786673,
    //% blockIdentity="blocks.block" enumval=852209 block="緑色の色付きガラス"
    //% jres alias=GREEN_STAINED_GLASS
    GreenStainedGlass = 852209,
    //% blockIdentity="blocks.block" enumval=917745 block="赤色の色付きガラス"
    //% jres alias=RED_STAINED_GLASS
    RedStainedGlass = 917745,
    //% blockIdentity="blocks.block" enumval=983281 block="黒色の色付きガラス"
    //% jres alias=BLACK_STAINED_GLASS
    BlackStainedGlass = 983281,
    //% blockIdentity="blocks.block" enumval=0 block="空気"
    //% jres alias=AIR
    Air = 0
}
